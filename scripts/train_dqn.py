"""Train DQN on an Atari environment with checkpoint saving."""
import os
import argparse
import yaml
...
def resume(checkpoint_path: str, env_id: str, additional_steps: int, save_dir: str, run_name: str):
    ...
    model.save(os.path.join(save_dir, run_name, "dqn_resumed_final"))
    vec_env.close()
